...
- **총괄(마스터)**: `.claude/skills/shopping-shorts-master/` (지시 · 단계별 검수 · 발행 패키지 승인) → `.claude/agents/shorts-master.md`
...
부서 규정과 공정은 `.claude/TEAM.md`, 프로젝트 지침은 루트 `CLAUDE.md` 에 있습니다. 한 편 전체는 `/shorts <제품명>`, 검수만은 `/shorts-qa` 로 돌립니다.
